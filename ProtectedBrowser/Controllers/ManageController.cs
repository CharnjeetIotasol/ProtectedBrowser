...
//namespace ProtectedBrowser.Controllers
//{
//    [Authorize]
...
//            return new AccountController.ChallengeResult(provider, Url.Action("LinkLoginCallback", "Manage"), User.Identity.GetUserId<long>());
//        }
